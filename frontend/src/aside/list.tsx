...
import {Box, BoxProps, ListItem, ListItemButton, ListItemText} from "@mui/material";
            ...
            {props.multiColumn ?
                <VirtuosoGrid
                    ...
                    components={{
                        ...
                        List: ListContainer,
                        ScrollSeekPlaceholder: () => <ListItem component='div'>--</ListItem>,
                    }}
                ...
                /> : <Virtuoso
                    ...
                    scrollerRef={(a) => dropProvided.innerRef(a as unknown as HTMLElement | null)}
                    totalCount={fields.length}
                    itemContent={index => renderRow(index)}
                />
            }
