...
pub(crate) fn frtb_calc_params() -> Vec<CalcParameter> {
    ...
    let params = [
        ("com_delta_diff_cty_rho_per_bucket_base", None, Some("vector 11".into())),
        ...
        ("csr_ctp_delta_diff_tenor_rho_base", None, Some("float".into())),
        ("csr_ctp_delta_diff_name_rho_per_bucket_base", None, Some("vector-depends on regulation. For BCBS 16.".into())),
        ("csr_ctp_diff_basis_rho_base", None, Some("float".into())),
        ("csr_ctp_vega_diff_name_rho_per_bucket_base", None, Some("vector-depends on regulation. For BCBS 16.".into())),
        ...
        ("eq_delta_diff_name_rho_per_bucket_base", None, Some("vector 13".into())),
        ("eq_delta_diff_type_rho_base", None, Some("float".into())),
        ("eq_vega_rho_diff_name_per_bucket_base", None, Some("vector 13".into())),
        ("eq_opt_mat_vega_rho_base", None, Some("matrix 5x5".into())),

        ("girr_delta_rho_same_curve_base", None, Some("matrix 10x10".into())),
    ...
    let params = [
        ...
        ("com_curv_diff_name_rho_per_bucket", None, Some("vector 11x11".into())),
        ...
        ("eq_curv_diff_name_rho_per_bucket", None, Some("vector 13".into())),
