...
pub(crate) fn csrsecnonctp_curv_measures() -> Vec<Measure> {
    vec![
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_curv_delta),
            aggregation: None,
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_curv_delta_weighted),
            aggregation: None,
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_pnl_up),
            aggregation: None,
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_pnl_down),
            aggregation: None,
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_cvr_up),
            aggregation: None,
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_cvr_down),
            aggregation: None,
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_curvature_kb_plus_medium),
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_curvature_kb_minus_medium),
            aggregation: Some("scalar"),
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_curvature_kb_medium),
            aggregation: Some("scalar"),
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_curvature_sb_medium),
            aggregation: Some("scalar"),
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_curvature_charge_medium),
            aggregation: Some("scalar"),
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_curvature_kb_plus_low),
            aggregation: Some("scalar"),
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_curvature_kb_minus_low),
            aggregation: Some("scalar"),
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_curvature_kb_low),
            aggregation: Some("scalar"),
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_curvature_sb_low),
            aggregation: Some("scalar"),
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_curvature_charge_low),
            aggregation: Some("scalar"),
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_curvature_kb_plus_high),
            aggregation: Some("scalar"),
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_curvature_kb_minus_high),
            aggregation: Some("scalar"),
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_curvature_kb_high),
            aggregation: Some("scalar"),
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_curvature_sb_high),
            aggregation: Some("scalar"),
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csr_sec_nonctp_curvature_charge_high),
            aggregation: Some("scalar"),
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
        ...
        Measure::Base(BaseMeasure {
            ...
            calculator: Arc::new(csrsecnonctp_curv_max),
            aggregation: Some("scalar"),
            precomputefilter: Some(
                col("RiskCategory")
                    .eq(lit("Delta"))
