...
//where F: Fn(f64) -> f64 + Sync,
    {
        ...
        let mut matrixes: [Array2<f64>; 16] = [
            self.com_gamma.to_owned(),
            self.com_gamma_curv.to_owned(),
            self.eq_gamma.to_owned(),
            self.csr_sec_nonctp_gamma.to_owned(),
            self.girr_vega_rho.to_owned(),
            self.fx_vega_rho.to_owned(),
            self.eq_gamma_curv.to_owned(),
            self.csr_nonsec_gamma.to_owned(),
            self.csr_nonsec_gamma_crr2.to_owned(),
            self.csr_ctp_gamma.to_owned(),
            self.csr_ctp_gamma_crr2.to_owned(),
            self.csr_nonsec_gamma_curv.to_owned(),
            self.csr_nonsec_gamma_crr2_curv.to_owned(),
            self.csr_ctp_gamma_curv.to_owned(),
            self.csr_ctp_gamma_crr2_curv.to_owned(),
