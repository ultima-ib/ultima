use ultibi_core::{filters::FilterE, datasource::fltr_chain_to_sql_query};
...
fn test_query_create() {
    ...
    let fltr = vec![
        ...
        vec![FilterE::NotIn{field:"CommodityLocation".into(), value: vec![Some("China".into()), Some("NY".into())]}],
